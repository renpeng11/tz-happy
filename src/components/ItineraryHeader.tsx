              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 min-w-[320px]">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 mt-3 pt-3 border-t border-white/20">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-amber-400 to-orange-400 text-white text-xs font-semibold px-3 py-1 rounded-lg hover:shadow-md transition-all flex items-center gap-1"
                  >
